  ...
  return (
    <div className="container-fluid  flex flex-wrap justify-center sd:gap-60 gap-4 items-center bg-black p-10 sm:pb-16 pb-4">
      <div className="story-card2">
        ...
        <div className="box-item md:w-3/5 p-2 sm:h-28 h-16 drop-shadow-md flex justify-between rounded-xl items-center bg-black ">
      ...
      <div className="xl:text-left text-center z-50">
